...
## 1️⃣ Executive Summary (Business Framing)
...
Supported by confusion matrices and classification reports in the notebooks to validate error patterns
...
1. 3 models (Logistic Regression, Decision Tree, Naive Bayes)
2. 2 preprocessing strategies (Stemming vs. Lemmatization)
3. 2 vectorization methods (Count Vectorizer vs. TF-IDF)
